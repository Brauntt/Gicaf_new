...
from interface.ModelBase import TfLiteModel
from interface.LoadDataBase import LoadDataBase
...
def EfficientNetB7(loadData: LoadDataBase, bit_width: int = 32) -> TfLiteModel:
    return TfLiteModel.from_tensorflowhub(
